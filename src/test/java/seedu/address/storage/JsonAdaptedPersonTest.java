...
public class JsonAdaptedPersonTest {
    ...
    @Test
    public void toModelType_personWithRemark_preservesRemark() throws Exception {
        Person personWithRemark = new PersonBuilder(BENSON).withRemark("Likes baseball").build();
